...
class FadeExample extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor() {
    super();
    this.state = {
      phraseIndex: 0
  ...
  scrollPhrases(index) {//if (index > this.phrases.length){  
    // index = 0    
    //}
    //this.setState({
    //  phraseIndex: index + 1
  ...
  render() {
    return __jsx("div", null, __jsx(react_reveal_Fade__WEBPACK_IMPORTED_MODULE_1___default.a, {
      top: true
    }, __jsx("h1", null, phrases[0])));
  }

}

/* harmony default export */ __webpack_exports__["default"] = (FadeExample);
