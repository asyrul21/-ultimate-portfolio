...
(0, _react2.storiesOf)('Lazyload Media', module).addWithChapters('Class based component', {
  ...
  chapters: [{
    sections: [{
      ...
      sectionFn: function sectionFn() {
        ...
        return /*#__PURE__*/_react["default"].createElement(_themeComponent.Card, {
      ...
      sectionFn: function sectionFn() {
        ...
        return /*#__PURE__*/_react["default"].createElement(_themeComponent.Card, {
          ...
          contentNode: iframeArray.map(function (iframe) {
            return /*#__PURE__*/_react["default"].createElement(_Iframe["default"], {
              key: iframe.src,
              src: iframe.src,
              ratio: iframe.ratio
            });
    ...
    sections: [{
      ...
      sectionFn: function sectionFn() {
        ...
        return /*#__PURE__*/_react["default"].createElement(_themeComponent.Card, {
          titleText: "Lazyload Image",
          contentNode: imageArray.map(function (image) {
            return /*#__PURE__*/_react["default"].createElement(_ImageFunctional["default"], {
              key: image.src,
              src: image.src,
              ratio: image.ratio
            });
      ...
      sectionFn: function sectionFn() {
        ...
        return /*#__PURE__*/_react["default"].createElement(_themeComponent.Card, {
          titleText: "Lazyload Iframe",
          contentNode: iframeArray.map(function (iframe) {
            return /*#__PURE__*/_react["default"].createElement(_IframeFunctional["default"], {
              key: iframe.src,
              src: iframe.src,
              ratio: iframe.ratio
            });
